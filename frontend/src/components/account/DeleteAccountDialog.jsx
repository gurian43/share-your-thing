            ...
            <Dialog.Content position="fixed" top="40%" left="50%" transform="translate(-50%, -50%)" maxW="500px" bg="gray.800">
                <Dialog.Body>
                    <VStack spacing={6} align="center" justify="center" py={8}>
                        ...
                        />
                        <HStack spacing={4}>
                            <Button variant="ghost" color="gray.300" _hover={{ bg: 'gray.600', color: 'white' }} onClick={onClose}>
                                Cancel
                            </Button>
                            <Button variant="ghost" color="red.300" _hover={{ bg: 'red.700', color: 'white' }} onClick={handleConfirm}>
                                Delete Account
                            </Button>
                        </HStack>
                    </VStack>
